...
def main():
    ...
    print(f"   • Automated Unit Tests:          {eng_evidence['automated_tests_passing']} / 130+ PASS")
    ...
    print(f"   • Failed Integrations:           NOT YET MEASURED")
    print(f"   • Production Deployment Intent:  UNKNOWN (Would Deploy Production: Yes/Maybe/No)")
    print(f"   • Primary Adoption Barrier:      UNKNOWN (Security / Framework / Complexity / Control Plane)")
