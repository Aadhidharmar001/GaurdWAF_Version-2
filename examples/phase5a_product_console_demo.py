...
from guardwaf.control_plane.app import ControlPlaneContainer, create_control_plane_app
...
def run_phase5a_demo():
    ...
    print(f"   ✅ Dashboard Stats Loaded: Total Agents={init_stats['total_agents']}, Active={init_stats['active_agents']}, Blocked Actions={init_stats['blocked_actions']}")
    ...
    v1_rules = {
        ...
        "hitl_rules": [{"tool": "process_payment", "condition_param": "amount", "greater_than": 500.0}]
    }
    ...
    asyncio.run(cp_container.sse_broadcaster.broadcast_event(acme_org.organization_id, {
