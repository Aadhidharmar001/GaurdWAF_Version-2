...
class MockMCPServer:
    ...
    def handle_request(self, request):
        ...
        return {"status": "EXECUTED", "tool": request.tool_name, "args": request.arguments}
...
def main():
    ...
    waf = GuardWAF(policy=PolicyConfig(metadata={"policy_name": "mcp_p10"}, rules=rules), secret_key="mcp_p10_secret_key_32bytes_long_min")
