...
def main():
    ...
    # 2. Package Build
    run_cmd([sys.executable, "scripts/build_release.py"], "Scenario 2: Building PyPI Release Package (sdist & wheel)")

    # 3. Package Verification
    run_cmd([sys.executable, "scripts/verify_package_install.py"], "Scenario 3: Verifying Clean Environment Package Installation")

    # 4. 60-Second Quickstart
    run_cmd([sys.executable, "examples/60_second_quickstart/main.py"], "Scenario 4: Executing 60-Second Quickstart Project")

    # 5-8. Real Customer Support Agent (Scenarios 5-8)
    run_cmd([sys.executable, "examples/real_world_integrations/customer_support_agent/main.py"], "Scenarios 5-8: Executing Real-World Customer Support Agent (Read, Refund, HITL, Zero-Exec Block)")

    # 9-10. Real MCP Agent (Scenarios 9-10)
    run_cmd([sys.executable, "examples/real_world_integrations/mcp_agent/main.py"], "Scenarios 9-10: Executing Real-World MCP Gateway Integration (Discovery & Mutation Block)")

    # 11. Real LangGraph Workflow (Scenario 11)
    run_cmd([sys.executable, "examples/real_world_integrations/langgraph_workflow/main.py"], "Scenario 11: Executing Real-World LangGraph Workflow Integration")
    ...
    # 20. Beta Dashboard
    run_cmd([sys.executable, "scripts/beta_dashboard.py"], "Scenario 20: Executing Public Beta Status & Intelligence Dashboard")
