...
def main():
    ...
    rules = PolicyRules(
        ...
        parameter_blocklist=[ParameterBlocklistRule(tool="cancel_order", param_name="order_id", blocklist=["SYSTEM_CRITICAL"])]
    )
    ...
    with waf.session(session_id="sess_supp_1"):
        ...
        app_res = hitl_service.approve_action(organization_id="default", pending_action_id=pending_id, approver_id="ciso_admin")
