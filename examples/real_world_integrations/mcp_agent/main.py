...
def main():
    ...
    with waf.session(session_id="sess_mcp_real_1"):
        ...
        filtered = mcp_gateway.filter_allowed_tools(
            "default", "mcp_agent", all_tools, allowed_tool_names=["sql_query"]
        )
        ...
        print(
            f"   🔒 Downstream MCP Executions Before: {exec_before}, After: {exec_after} (Delta: 0)"
        )
