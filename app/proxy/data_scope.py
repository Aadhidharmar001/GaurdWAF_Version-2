...
from app.models import ToolCallRequest, DataScopeRule, RuleResult

def evaluate_data_scope(req: ToolCallRequest, rule: DataScopeRule, global_shadow: bool = False) -> Optional[RuleResult]:
    ...
    if req.session_context and req.session_context.allowed_scope_ids and param_val is not None:
        allowed_scope_ids = {str(scope_id) for scope_id in req.session_context.allowed_scope_ids}
