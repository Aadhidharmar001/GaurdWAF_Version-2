...
from app.db.orm_models import Base, AuditLog
from app.models import ToolCallRequest, SessionContext, PolicyConfig
...
def test_rate_limiting(db_session, policy):
    ...
    for _ in range(3):
        log_audit_event(db_session, req.agent_id, req.session_id, req.tool, req.parameters, "Clear", None, "allowed")
