...
from guardwaf.control_plane.models.org import Organization, User, OrganizationMembership, Role, OrgStatus, UserStatus
...
class OrgService:
    ...
    def create_user(self, email: str, display_name: str) -> User:
        ...
        user = User(user_id=user_id, email=email, display_name=display_name, status=UserStatus.ACTIVE)
