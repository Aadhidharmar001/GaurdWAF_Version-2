...
class AuthorityService:
    ...
    def revoke_authority(self, authority_id: str, actor_id: str = "admin", reason: str = "Revoked by admin") -> CentralAuthorityRecord:
        ...
        if self.audit_service:
            self.audit_service.record_event("AUTHORITY_REVOKED", record.tenant_id, actor_id, "authority", authority_id, {"reason": reason})
