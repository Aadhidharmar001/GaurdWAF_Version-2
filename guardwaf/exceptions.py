...
class GuardWAFSecurityError(GuardWAFException):
    ...
    """
    def __init__(self, message: str, tool_name: str, matched_rule: Optional[str] = None, details: Optional[dict] = None, code: Optional[str] = None):
...
class GuardWAFAlreadyExecutedError(GuardWAFSecurityError):
    ...
    def __init__(self, message: str, tool_name: str, pending_action_id: str):
        super().__init__(message, tool_name=tool_name, matched_rule="idempotency_check", code="ALREADY_EXECUTED")
        self.pending_action_id = pending_action_id
...
class GuardWAFIdentityError(GuardWAFSecurityError):
    ...
    def __init__(self, message: str, tool_name: str = "identity_verification", code: str = "IDENTITY_ERROR"):
...
class GuardWAFAuthorizationError(GuardWAFIdentityError):
    ...
    def __init__(self, message: str, tool_name: str = "unknown", code: str = "AUTHORIZATION_DENIED"):
        super().__init__(message, tool_name=tool_name, code=code)
...
class GuardWAFUnverifiedContextError(GuardWAFIdentityError):
    ...
    def __init__(self, message: str = "Action executed without a cryptographically verified principal context."):
