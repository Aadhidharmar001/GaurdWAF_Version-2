...
from guardwaf.sdk.context import get_current_session, get_current_execution_context
...
from guardwaf.exceptions import GuardWAFSecurityError, GuardWAFHITLRequiredError
        ...
        if asyncio.iscoroutinefunction(func):
            ...
            async def async_wrapper(*args, **kwargs) -> Any:
                ...
                event = TelemetryEvent(
                    event_type="ACTION_PENDING" if eval_res.status == "pending_hitl" else ("ACTION_BLOCKED" if eval_res.status == "blocked" else "ACTION_ALLOWED"),
                ...
                if eval_res.status == "blocked":
                    ...
                    raise GuardWAFSecurityError(
                        ...
                        tool_name=target_name,
                        matched_rule=eval_res.matched_rule,
                        details={"status": eval_res.status, "risk_level": eval_res.risk_level}
                    )
