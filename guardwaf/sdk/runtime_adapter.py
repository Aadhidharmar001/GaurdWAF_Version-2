...
from guardwaf.exceptions import GuardWAFSecurityError, GuardWAFAuthorizationError
...
class AgentRuntimeAdapter:
    ...
    def authorize_action(
        ...
        if status == "allowed":
            ...
            return False, f"Action '{envelope.tool_name}' blocked by GuardWAF policy: {rule_res.outcome}", None, None
